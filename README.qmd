...
```{r MMI_histogram, echo=F, fig.cap="Figure 4: Histogram of the site averaged multi metric index"}
data4model %>% ggplot()+
  geom_histogram(
    aes(x = MMI_mean),
    fill = "#99CCCC",
...
```{r EQC_histogram, echo=F, fig.cap="Figure 5: Histogram of the site averaged ecological quality class"}
data_all %>% ggplot()+
  geom_histogram(
    aes(x = EQC_mean),
    stat = "count",
...
```{r autocorrelation_plot, echo=F, fig.cap="Figure 6: Correlation plot of covariates"}
...
We first separate the available data into a training and test set by a ratio of 80% to 20% respectively.
